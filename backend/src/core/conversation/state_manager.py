# backend/src/core/conversation/state_manager.py
...
class ConversationStateManager:
    ...
    async def get_conversation_session(self, session_id: str) -> ConversationSession:
        ...
        if not session_data:
            # Create new session starting with intent selection
            session = ConversationSession(
                session_id=session_id,
                current_state=ConversationState.INTENT_SELECTION,
                context=ConversationContext()
            )
...
VALID_TRANSITIONS = {
    ConversationState.INITIAL: [ConversationState.INTENT_SELECTION],
    ConversationState.INTENT_SELECTION: [
    ...
    ConversationState.PRODUCT_SEARCH_INIT: [
        ...
        ConversationState.INTENT_SELECTION,  # Allow going back
        ConversationState.ERROR
    ],
    ConversationState.VEHICLE_INFO_COLLECTION: [
    ...
    ConversationState.PRODUCT_PRESENTATION: [
        ...
        ConversationState.INTENT_SELECTION,  # Start new search
        ConversationState.ERROR
    ],
    ConversationState.PRICE_NEGOTIATION: [
        ConversationState.ORDER_CONFIRMATION,
    ...
    ConversationState.ORDER_CONFIRMATION: [
        ...
        ConversationState.INTENT_SELECTION,  # Start new conversation
        ConversationState.ERROR
    ],
    # Error state can transition anywhere
    ConversationState.ERROR: list(ConversationState),
    # End state can restart
    ConversationState.END: [ConversationState.INTENT_SELECTION]
}
